...
{
	public class AdpLoadingST : BaseAdapter
	{
		private List<tblLoadingSTList> _items;
		private Activity _context;

		public AdpLoadingST(Activity context, List<tblLoadingSTList> items)
		{
			_context = context;
			_items = items;
		}
		...
		public tblLoadingSTList GetItemDetail(int position)
		{
